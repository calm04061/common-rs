// pub use sqlx_oracle::{Oracle, OracleRow, OracleValueRef};
//
...
// }
//
// pub fn get_first<T: for<'r> From<&'r OracleRow>>(result: DbResult<Vec<OracleRow>>) -> DbResult<Option<T>> {
//     if let Err(e) = result {
//         return Err(e);
//     }
//     let rows = result?;
...
// }
//
// pub fn convert<T: for<'r> From<&'r OracleRow>>(result: DbResult<Vec<OracleRow>>) -> DbResult<Vec<T>> {
//     if let Err(e) = result {
//         return Err(e);
//     }
...
//
// #[async_trait]
// #[deprecated(note = "Use crate::dao::async_dao::AsyncSimpleDao instead — unified across backends")]
